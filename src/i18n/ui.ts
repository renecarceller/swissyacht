...
const dictionaries: Record<Locale, UiDictionary> = {
  fr: {
    ...
    listing: {
      ...
      fraudText: "N'envoyez pas de paiement avant d'avoir vérifié l'embarcation, le vendeur et les documents. SwissYacht ne demande jamais de paiements directs par email.",
      similar: "Annonces similaires",
      demoDescription: "Annonce démo créée pour le MVP SwissYacht. Les données du bateau sont illustratives et doivent être remplacées par des informations vérifiées du vendeur avant une publication en production.",
    ...
    legal: {
      ...
      placeholder1: "Placeholder provisoire. Ce texte doit être révisé et adapté par un conseil juridique qualifié en Suisse avant la mise en production de SwissYacht.",
  ...
  de: {
    ...
    legal: { legalNotice: "Impressum", terms: "Allgemeine Bedingungen", privacy: "Datenschutzerklärung", cookies: "Cookies", fraud: "Sicherheit und Betrugsprävention", contact: "Kontakt", publishingRules: "Inseratsregeln", fallback: "Rechtsseite", placeholder1: "Vorläufiger Platzhalter. Dieser Text muss vor der Produktion von SwissYacht durch qualifizierte Schweizer Rechtsberatung geprüft und angepasst werden.", placeholder2: "Hier werden Verantwortlichkeiten, Datenschutz, Cookies, Publikationsregeln, Kontakt, Betrugsprävention und Pflichten für den Schweizer Markt dokumentiert." },
    professionals: { title: "SwissYacht für Profis", intro: "Öffentliche Profile, zentrales Inventar, gewerbliche Anfragen und Grundlage für Abonnements.", included: "Professionelle Architektur enthalten", rows: "Firmenprofil|Logo, Adresse, Sprachen, Website und Telefone.|Inventar|Mehrere Inserate und Moderationsstatus.|Anfragen|Zentrale Kontakte pro Inserat.|Statistiken|Aufrufe und Basiskennzahlen." },
    refs: {}
  },
  it: {
