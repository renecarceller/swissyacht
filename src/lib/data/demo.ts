...
const baseListings = [
  ...
  ["seadoo-gti-neuchatel-12360", "Sea-Doo GTI 130", "Jet skis", "Jet ski", "Sea-Doo", "GTI 130", 2022, 15900, "Neuchatel", "Lake Neuchatel", "Cudrefin", "Cudrefin", 3.32, 1.25, "Petrol", "Jet", 130]
] as const;
