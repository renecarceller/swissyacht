...
export async function generateMetadata({ params }: { params: Promise<{ locale: string; slug: string }> }): Promise<Metadata> {
  ...
  return {
    title: `${broker.companyName} - Barcos en venta en Suiza | SwissYacht`,
    description: `Descubra los barcos disponibles de ${broker.companyName}, profesional nautico en ${broker.canton || "Suiza"}. Informacion, servicios y contacto directo en SwissYacht.`,
    openGraph: {
      title: `${broker.companyName} | SwissYacht`,
...
function brokerLabels(locale: string) {
  const dictionaries = {
    fr: { professional: "Professionnel nautique", boats: "bateaux", about: "Informations de l'entreprise", noDescription: "Ce professionnel n'a pas encore ajoute de description publique.", address: "Adresse", languages: "Langues", hours: "Horaires", byAppointment: "Sur rendez-vous", memberSince: "Membre depuis", services: "Services", noServices: "Aucun service indique.", catalog: "Catalogue de bateaux", results: "resultats", sort: "Trier", apply: "Appliquer", sortDate: "Date recente", sortPriceAsc: "Prix croissant", sortPriceDesc: "Prix decroissant", sortYearDesc: "Annee recente", sortYearAsc: "Annee ancienne", empty: "Aucun bateau actif pour ce professionnel.", contact: "Contacter", call: "Appeler", email: "Envoyer un email", website: "Page web", map: "Carte", mapPlaceholder: "Carte a connecter avec les coordonnees du broker.", gallery: "Galerie", allBoats: "Voir tous les bateaux" },
    de: { professional: "Nautischer Profi", boats: "Boote", about: "Unternehmensinformationen", noDescription: "Dieser Profi hat noch keine oeffentliche Beschreibung hinzugefuegt.", address: "Adresse", languages: "Sprachen", hours: "Oeffnungszeiten", byAppointment: "Nach Vereinbarung", memberSince: "Mitglied seit", services: "Services", noServices: "Keine Services angegeben.", catalog: "Bootskatalog", results: "Resultate", sort: "Sortieren", apply: "Anwenden", sortDate: "Neueste", sortPriceAsc: "Preis aufsteigend", sortPriceDesc: "Preis absteigend", sortYearDesc: "Neues Baujahr", sortYearAsc: "Altes Baujahr", empty: "Keine aktiven Boote fuer diesen Profi.", contact: "Kontakt", call: "Anrufen", email: "E-Mail senden", website: "Webseite", map: "Karte", mapPlaceholder: "Karte mit Broker-Koordinaten verbinden.", gallery: "Galerie", allBoats: "Alle Boote anzeigen" },
...
function badgeLabel(locale: string, badge: string) {
  const labels: Record<string, string> = {
    verified_broker: locale === "de" ? "Verifiziert" : locale === "it" ? "Verificato" : locale === "en" ? "Verified" : "Verifie",
