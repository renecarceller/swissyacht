...
function professionalDashboardLabels(locale: string) {
  const dictionaries = {
    fr: { title: "Panel professionnel", intro: "Gerez votre entreprise, votre catalogue, vos contacts et votre visibilite.", boats: "Mes bateaux", boatsText: "Inventaire, brouillons et annonces publiees.", leads: "Leads et contacts", leadsText: "Demandes recues depuis vos annonces.", company: "Profil entreprise", companyText: "Logo, adresse, horaires, services et galerie.", stats: "Statistiques", statsText: "Visites, favoris et demandes.", import: "Importer annonces", importText: "Base preparee pour CSV et Excel.", team: "Equipe", teamText: "Prepare pour owner, admin, editor et viewer." },
    de: { title: "Profi-Bereich", intro: "Verwalten Sie Firma, Katalog, Kontakte und Sichtbarkeit.", boats: "Meine Boote", boatsText: "Inventar, Entwuerfe und veroeffentlichte Inserate.", leads: "Leads und Kontakte", leadsText: "Anfragen aus Ihren Inseraten.", company: "Firmenprofil", companyText: "Logo, Adresse, Zeiten, Services und Galerie.", stats: "Statistiken", statsText: "Aufrufe, Favoriten und Anfragen.", import: "Inserate importieren", importText: "Vorbereitet fuer CSV und Excel.", team: "Team", teamText: "Vorbereitet fuer Owner, Admin, Editor und Viewer." },
    it: { title: "Pannello professionale", intro: "Gestisci azienda, catalogo, contatti e visibilita.", boats: "Le mie barche", boatsText: "Inventario, bozze e annunci pubblicati.", leads: "Lead e contatti", leadsText: "Richieste ricevute dagli annunci.", company: "Profilo azienda", companyText: "Logo, indirizzo, orari, servizi e galleria.", stats: "Statistiche", statsText: "Visite, preferiti e richieste.", import: "Importa annunci", importText: "Preparato per CSV ed Excel.", team: "Team", teamText: "Preparato per owner, admin, editor e viewer." },
