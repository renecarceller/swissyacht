...
function registerLabels(locale: string) {
  const dictionaries = {
    fr: {
      choiceTitle: "Quel type de compte souhaitez-vous creer ?",
      choiceIntro: "Choisissez le compte adapte a votre activite nautique.",
      ...
      firstName: "Prenom",
      lastName: "Nom",
      createPrivate: "Creer mon compte",
      accessData: "Donnees d'acces",
      companyData: "Informations de l'entreprise",
      publicPresentation: "Presentation publique",
      language: "Langue",
      ...
      createProfessional: "Creer le compte professionnel"
    },
    de: {
      choiceTitle: "Welche Kontoart moechten Sie erstellen?",
      choiceIntro: "Waehlen Sie das passende Konto fuer Ihre nautische Aktivitaet.",
      privateTitle: "Privat",
      privateText: "Fuer Personen, die ihr eigenes Boot verkaufen moechten.",
      proTitle: "Broker / Profi",
      proText: "Fuer Broker, Haendler, Marinas und nautische Unternehmen.",
      fastRegister: "Schnelle Registrierung",
      simplePublish: "Einfaches Inserieren",
      manageListings: "Inserate verwalten",
      publicCompany: "Oeffentliches Firmenprofil",
      ...
      publicPresentation: "Oeffentliche Praesentation",
      language: "Sprache",
    ...
    it: {
      ...
      choiceIntro: "Scegli l'account adatto alla tua attivita nautica.",
